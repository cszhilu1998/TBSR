...
class SynTestDataset(BaseDataset):
	def __init__(self, opt, split='train', dataset_name='syntest'):
		super(SynTestDataset, self).__init__(opt, split, dataset_name)

		if self.root == '':
			rootlist = ['/Data/dataset/Burst_SR/synburst_test_2022/']
